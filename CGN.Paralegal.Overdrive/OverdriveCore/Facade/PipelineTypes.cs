...
namespace LexisNexis.Evolution.Overdrive
{
    ...
    {
        public PipelineType (string moniker)
        {
            Moniker = moniker;
        }
        ...
        public static bool operator ==(PipelineType a, PipelineType b)
        {
        ...
        public static bool operator !=(PipelineType first, PipelineType second)
        {
            return !(first == second);
        }
    }
